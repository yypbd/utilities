...
### Common
- [Midnight Commander](http://midnight-commander.org/) - Terminal file manager
...
### Windows
- [Launchy](https://www.launchy.net/) - Launcher, [설명](https://m.clien.net/service/board/use/14929826?type=recommend)
...
#### Common
- [Photoscape](http://www.photoscape.org/ps/main/index.php) - 이미지 편집
- [Gimp](https://www.gimp.org/) - 이미지 편집

#### Windows
- [꿀뷰](https://www.bandisoft.co.kr/honeyview/ing/) - 이미지 뷰어

### Compress

#### Windows
- [반디집](https://www.bandisoft.co.kr/bandizip/) - 압축 유틸리티

### Network

#### Common
- [FileZilla](https://filezilla-project.org/) - FTP Server/Client
...
- [JiTouch](https://github.com/aaronkollasch/jitouch) - 트랙패드 제스처 설정 [설명](https://www.clien.net/service/board/cm_mac/16774332?po=0&sk=title&sv=jitouch&groupCd=&pt=0)
